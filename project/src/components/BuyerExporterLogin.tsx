...
interface BuyerExporterLoginProps {
  onLogin: () => void;
}

const BuyerExporterLogin: React.FC<BuyerExporterLoginProps> = ({ onLogin }) => {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-subtle font-sans">
            Welcome. Discover the real story behind your coffee.
          </p>
        </div>
...
export default BuyerExporterLogin;