...
interface CoffeeBrandSidebarProps {
...
const CoffeeBrandSidebar: React.FC<CoffeeBrandSidebarProps> = ({ 
  activeSection, 
  onSectionChange, 
  onLogout,
  isMobileOpen,
  ...
  const menuItems = [
    { id: 'explore-producers', label: 'Explore Producers', icon: Search },
    { id: 'view-certificates', label: 'View Certificates', icon: Award },
    { id: 'traceability-map', label: 'Traceability Map', icon: MapPin },
    { id: 'statistics', label: 'Statistics', icon: BarChart3 },
    { id: 'profile-settings', label: 'Profile & Settings', icon: User },
    { id: 'featured-batches', label: 'Featured Batches', icon: Star },
...
export default CoffeeBrandSidebar;